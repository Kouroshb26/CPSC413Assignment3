...
public class Algorithm {
    ...
    public static void main(String[] args) {
        Algorithm algorithm = new Algorithm("");
        ...
        System.out.println("Time in milli seconds"+(end-start)/1000);
